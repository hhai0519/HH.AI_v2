...
| TG-MVP-13 | 進行中 | **Telegram 出站文字發送適配器**（Telegram outbound text delivery）：由 Outbox worker 取出待送文字訊息，透過 Telegram Bot API 送出並標記完成或重試。（註：D-R3-A+、D-R3-C1、D-R3-REPLY-A 已由使用者裁決；D-R2 deferred before TG-MVP-15）。TG-MVP-13 R0 = MACRO HOLD；TG-MVP-13 R1 = MACRO HOLD；TG-MVP-13 R2 = ACTIVE（非阻塞異步帳號邊界與生命週期閉合修復中，NEXT_WORK = E-03，NEXT_SLICE = TG-MVP-13，不得進 TG-MVP-14）。 | 使用者裁決 D-U4、ADR-0022、D-R1、D-R3-A+、D-R3-C1、D-R3-REPLY-A、D-R4 | TG-MVP-10, TG-MVP-12 | 測試機器人文字回覆成功送達 Telegram 聊天室 |
