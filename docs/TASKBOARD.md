...
| TG-MVP-11 | 進行中 | **本機迴路 Local API v1 實作**（Loopback Local API v1）：實作僅限 127.0.0.1 監聽、具備 HMAC 簽章驗證之 HTTP 入口，供本機 Agent 發送出站回覆與查詢狀態。 | 使用者裁決 R3、TG-MVP-03 (R3 ADR)、TG-MVP-06 (B-98)、TG-MVP-04 (F1)、TG-MVP-07A | TG-MVP-03, TG-MVP-04, TG-MVP-06, TG-MVP-06A, TG-MVP-07A | 進行中（IN PROGRESS / IMPLEMENTATION CANDIDATE AWAITING EXTERNAL MACRO）；實作 127.0.0.1 綁定、HMAC 驗證、回覆授權與客戶端 CLI 包裝器；前置客戶端缺陷已由有界根因排除修復，T1–T23 突變測試 23/23 valid semantic RED，單元測試、迴歸測試全數 PASS，等待外部宏觀審計。 |
