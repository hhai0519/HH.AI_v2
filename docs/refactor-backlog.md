...
- 本批（尚未 commit）（`PRINCIPLES.md` §2.9 移除前複查原則 ＋
  五處落點 ＋ B-50 自檢聲明不可豁免 ＋ B-52 §6.7 擴七類 ＋
  B-53 至 B-61 共九項登錄）已執行，**尚待審計官核對**，見 §5.4。
...
- **本批（`PRINCIPLES.md` §2.9 ＋ 五處落點 ＋ B-50 ＋ B-52 ＋
  B-53 至 B-61 登錄）已執行完成，等待審計官核對。**
- **批 2b 已拆為 2b-1 與 2b-2**。本批為 2b-1，純規則層、零新程式。
  理由：加入使用者的兩個附加條件後會變成 13 檔含新程式，
  超出 `.claude/rules/auditor-protocol.md` §8.4-2 的可驗證上限；
  且新程式無舊版可 diff，與規則變更混批會讓錯誤難以歸因（2a 的教訓）。
