...
- **本批（修正兩個假 CHECK ＋ 寫入後原文驗證）已執行完成，
  等待審計官核對。**
  核對通過後，下一批要做：更新 §5.1 的 HEAD、打 `audited-0213568`
  與 `audited-<本批 hash>`、以及進入 **D-01 E1 注入測試**。
