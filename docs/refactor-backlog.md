...
- 本批（尚未 commit）（B-62 規則層變更的模擬閘門 ＋ B-61 圍欄數進 §3.6
  ＋ B-63 移除硬編碼項數 ＋ B-64／B-65 閘門自身的兩個缺口）已執行，
  **尚待審計官核對**，見 §5.4。**本批為第三投**：前兩投分別因
  審計官未重跑模擬、以及雜湊原語錯誤而被執行者攔下，見第 50 點 C 段。
...
- **本批（B-62 模擬閘門 ＋ B-61 圍欄數進 §3.6 ＋ B-63 移除硬編碼項數
  ＋ B-64／B-65 閘門自身缺口）已執行完成，等待審計官核對。**
  本批為 2b-2，純規則層、零新程式。
