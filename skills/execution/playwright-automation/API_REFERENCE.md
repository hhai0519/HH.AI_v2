...
export default defineConfig({
  ...
  reporter: 'html',
  use: {
    baseURL: 'http://localhost:3002', // Explicit example target (e.g. Next.js reservation)
  ...
  webServer: {
    ...
    url: 'http://localhost:3002', // Explicit example target
...
// Parameterized tests
const testData = [
  { username: 'user1', password: '<SECRET_PASSWORD>', expected: 'Welcome user1' },
  { username: 'user2', password: '<SECRET_PASSWORD>', expected: 'Welcome user2' },
];
